...
const Showcase: FC<ShowcaseProps> = ({ slice }) => {
  return (
    ...
    >
      ...
      />
      <div className="mt-16 grid items-center gap-8 rounded-xl border border-blue-50/20 bg-gradient-to-b from-slate-50/15 to-slate-50/5 px-8 py-8 backdrop-blur-sm md:gap-0 lg:grid-cols-3 lg:py-12">
        <div>
