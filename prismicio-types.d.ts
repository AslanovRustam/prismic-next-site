...
/**
 * Item in *Bento → Default → Primary → Box item*
 */
export interface BentoSliceDefaultPrimaryBoxItemItem {
  /**
   * Title field in *Bento → Default → Primary → Box item*
   *
   * - **Field Type**: Title
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.box_item[].title
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  title: prismic.TitleField;

  /**
   * Body field in *Bento → Default → Primary → Box item*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.box_item[].body
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  body: prismic.RichTextField;

  /**
   * Image box field in *Bento → Default → Primary → Box item*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.box_item[].image_box
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  image_box: prismic.ImageField<never>;

  /**
   * Wide field in *Bento → Default → Primary → Box item*
   *
   * - **Field Type**: Boolean
   * - **Placeholder**: *None*
   * - **Default Value**: false
   * - **API ID Path**: bento.default.primary.box_item[].wide
   * - **Documentation**: https://prismic.io/docs/field#boolean
   */
...
export interface BentoSliceDefaultPrimary {
  ...
  /**
   * Box item field in *Bento → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.box_item[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  box_item: prismic.GroupField<Simplify<BentoSliceDefaultPrimaryBoxItemItem>>;
}
 ...
 */
export interface IntegrationSliceDefaultPrimaryIconsItem {
  /**
   * Icon field in *Integrations → Default → Primary → Icons*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **API ID Path**: integration.default.primary.icons[].icon
   * - **Documentation**: https://prismic.io/docs/field#select
   */
  icon: prismic.SelectField<
    "cloudfare" | "npm" | "github" | "figma" | "digitalocean" | "fly"
  >;
}
...
export interface IntegrationSliceDefaultPrimary {
   ...
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: integration.default.primary.icons[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  icons: prismic.GroupField<Simplify<IntegrationSliceDefaultPrimaryIconsItem>>;
}
...
export interface ShowcaseSliceDefaultPrimary {
  ...
  /**
   * ButtonText field in *Showcase → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: showcase.default.primary.buttontext
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
...
export interface ShowcaseSliceReversePrimary {
  ...
  /**
   * ButtonText field in *Showcase → Reverse → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: showcase.reverse.primary.buttontext
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  buttontext: prismic.KeyTextField;
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      AllDocumentTypes,
      BentoSlice,
      BentoSliceDefaultPrimaryBoxItemItem,
      ...
      HeroSliceDefault,
      IntegrationSlice,
      IntegrationSliceDefaultPrimaryIconsItem,
